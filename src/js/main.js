  ...
  if ($(".catalog--products").length > 0) {
    ...
    $(".catalog--products-ul .product").each(function () {
      ...
      if (item_fixprice > 0) {
        ...
        // Золото -40%, Серебро -30%, Платина -25%, Палладиум -35% (Москва, Питер)
        // Золото -50%, Серебро -35%, Платина -30%, Палладиум -40% (ост города)
        item_price = (item_gold * GOLD * 0.6 + item_silver * SILVER * 0.7 + item_platinum * PLATINUM * 0.75 + item_palladium * PALLADIUM * 0.65) * USD;
        //item_price = (item_gold * GOLD * 0.5 + item_silver * SILVER * 0.65 + item_platinum * PLATINUM * 0.7+ item_palladium * PALLADIUM * 0.6) * USD;
